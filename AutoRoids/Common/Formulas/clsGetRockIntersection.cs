...
namespace AutoRoids.Common.Formulas
{
    internal class clsGetRockIntersection
    {
        ...
        private List<List<Point2d>> AddStartAndEndPoints(List<int> lstRow, List<GameLine> lstLine, List<List<Point2d>> lstLstPoint)
        {
        ...
        private List<Point2d> LineToMyPoint(GameLine MyLine)
        {
            return new List<Point2d>() { MyLine.ptStart, MyLine.ptEnd };
        }

        private List<GameLine> PointsToMyLine(List<Point2d> lstPoint)
        {
